...
function DepartmentHeroSection() {
    const content = {
        title: "Get to Know Our Departments",
        ...
        imageUrl: "https://prohealth-react.vercel.app/images/departments/banner_img.png",
        imageAlt: "Doctor smiling and holding out hand",
        pills: ['Blood Testing', 'Pathology', 'Microbiology'] // Updated pills data
    };
    ...
    return (
        <>
            ...
            <section className="DepartmentHeroSection-section">
                <div className="DepartmentHeroSection-content">
