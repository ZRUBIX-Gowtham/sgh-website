...
function AboutHeroSection() {
     const content = {
        title: "Welcome to Gopi Hospitals & Healthcare Center",
        description: "At Gopi Hospitals, we are dedicated to providing exceptional healthcare services with a compassionate touch. Our state-of-the-art facility and experienced medical professionals ensure that you receive the best possible care.",
        imageUrl: "https://prohealth-react.vercel.app/images/doctors/banner_img.png",
        imageAlt: "Doctor smiling and holding out hand",
    pills: ['Quality Care', 'Experienced Doctors', 'Modern Facilities',]
