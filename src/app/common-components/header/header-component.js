...
function HeaderComponent({ showScrolledVariant = true }) { // Added showScrolledVariant prop with default true
            ...
            <div id="contactOverlay" className={`contact-overlay ${isContactOverlayOpen ? 'active' : ''}`} ref={contactOverlayRef}>
                ...
                <div className="contact-overlay-content">
                    ...
                    <div className="contact-info-card">
                        ...
                        <div className="text-content">
                            <h4>Address</h4>
                            <p>23, B, Gopi Hospital, Ramakrishna Rd,Hasthampatti, Salem, Tamil Nadu 636007</p>
                        </div>
                    </div>
