...
function DoctorHeroSectionDesign() {
    const content = {
       title: "Get to Know Our Doctors",
        ...
        pills: ['Cardiology', 'Neurology', 'Pediatrics', 'Orthopedics']
    };
    ...
    return (
        <>
            ...
            <section className="DoctorHeroSection-section">
                <div className="DoctorHeroSection-content">
...
export default DoctorHeroSectionDesign;